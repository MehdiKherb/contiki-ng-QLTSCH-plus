...
#define TSCH_CONF_MAX_INCOMING_PACKETS 64
/* Number of routes */
...
#define FIRMWARE_TYPE_ALICE_RX_MULTICHANNEL 9
...
#elif FIRMWARE_TYPE == FIRMWARE_TYPE_ALICE || FIRMWARE_TYPE == FIRMWARE_TYPE_ALICE_RX_MULTICHANNEL
...
#if FIRMWARE_TYPE != FIRMWARE_TYPE_ALICE && FIRMWARE_TYPE != FIRMWARE_TYPE_ALICE_RX_MULTICHANNEL
...
#if FIRMWARE_TYPE == FIRMWARE_TYPE_ALICE_RX_MULTICHANNEL
