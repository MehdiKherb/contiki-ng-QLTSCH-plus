...
SELF_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) #/home/user/contiki-ng/examples/autonomous
...
def execute_test(directory, cooja_file):
    ...
    f = os.path.join(SELF_PATH + "/3-orchestra", cooja_file)
...
def main():
    ...
    for i in range(1, 11):
    	print("======= Running =======>", i)
        execute_test_run('hello')
        new_name = "Orchestra_"+str(i)+".txt"
        shutil.copyfile("COOJA.testlog", new_name)
    print(50*"#","\nall done\n", 50*"#")
