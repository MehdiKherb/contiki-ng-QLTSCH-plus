...
SELF_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) #/home/user/contiki-ng/examples
...
def execute_test(directory, cooja_file):
    ...
    f = os.path.join(SELF_PATH + "/2-new-ql-tsch", cooja_file)
