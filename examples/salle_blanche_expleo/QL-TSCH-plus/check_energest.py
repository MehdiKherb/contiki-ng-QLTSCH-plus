...
def save_as_xlsx(protocol):
    ...
    df1.to_excel(writer, sheet_name='Radio_total')
    df2.to_excel(writer, sheet_name='Rx_Energy')
    df3.to_excel(writer, sheet_name='Tx_Energy')
...
if __name__ == "__main__":
    protocol = sys.argv[1]
    for i in range(1, 2):
        file_name = protocol + "_" + str(i) + ".txt"
        print('\n', "@"*20, "File Number", i, "@"*20)
        main(file_name)
