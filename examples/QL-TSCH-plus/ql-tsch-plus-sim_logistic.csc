...
<simconf version="2022112801">
  <simulation>
    ...
    <motetype>
      ...
      <description>QL-TSCH-plus mote</description>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="34.534561788333015" y="35.58290185550088" />
        </interface_config>
        <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.12049062049062 0.0 0.0 3.12049062049062 80.94712338945668 44.27805487052544</viewport>
    </plugin_config>
    <bounds x="-4" y="9" height="400" width="400" />
  </plugin>
  <plugin>
...
while (true) {
  ...
  YIELD();
    ...
    <bounds x="1112" y="8" height="700" width="600" z="1" />
  </plugin>
</simconf>
