...
if __name__ == "__main__":
    ...
    df3 = DataFrame({'Delay_50B': [main_list[x][0] for x in range(10)], 'PDR_50B': [main_list[x][1] for x in range(10)], 'Delay_10B': [main_list[x][2] for x in range(10)], 'PDR_10B': [main_list[x][3] for x in range(10)], 'Delay_Network': [main_list[x][4] for x in range(10)], 'PDR_network': [main_list[x][5] for x in range(
        10)], 'TotalData_KB': [main_list[x][6] for x in range(10)], 'Active_Nodes': [main_list[x][7] for x in range(10)]})
