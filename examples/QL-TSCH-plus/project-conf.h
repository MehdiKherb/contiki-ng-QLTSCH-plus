...
#define NBR_TABLE_CONF_MAX_NEIGHBORS 64   // /2
#undef RPL_CONF_MOP
//#define RPL_CONF_MOP RPL_MOP_NON_STORING
#define RPL_CONF_MOP RPL_MOP_STORING_MULTICAST


// additional settings for large networks
/*#define TSCH_CONF_EB_PERIOD (4 * CLOCK_SECOND)
#define TSCH_CONF_MAX_EB_PERIOD (256 * CLOCK_SECOND)

#define TSCH_CONF_KEEPALIVE_TIMEOUT (24 * CLOCK_SECOND)
#define TSCH_CONF_MAX_KEEPALIVE_TIMEOUT (90 * CLOCK_SECOND)
*/

//#define RPL_CONF_DIO_INTERVAL_MIN                         10 /* 2^(10) = 1.024 s */
//#define RPL_CONF_DIO_INTERVAL_DOUBLINGS                   6  /* 2^(10+6) = 65.536 s */

//#define RPL_CONF_DIS_INTERVAL                             30 * CLOCK_SECOND
//#define RPL_CONF_PROBING_INTERVAL                         60 * CLOCK_SECOND

//#define RPL_CONF_WITH_DAO_ACK                             0  /* this needs more testing */
/*#if RPL_CONF_WITH_DAO_ACK
#  define RPL_CONF_DAO_RETRANSMISSION_TIMEOUT             120 * CLOCK_SECOND
#endif*/
// end ..
...
#define UNICAST_SLOTFRAME_LENGTH 9
...
// #define TSCH_CONF_MAX_FRAME_RETRIES 0
...
// macros to enable QL-TSCH in tsch libriaries
#define QL_TSCH_ENABLED 1
...
#define PRINT_Q_VALUES_AND_APT 0
